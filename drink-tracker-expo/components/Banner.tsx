...
const Banner = (props: BannerProps) => {
    ...
    const getMessage = () => {
        if (props.actualDrinks === 0) {
            ...
            setBody('It\'s recommended to start with shots and then move to lighter drinks like beers later');
            return;
        }
        ...
        if (drinkDifference === 0) {
            ...
            setBody('Give your drink to someone else and tell them to cut you off.');
        } else {
